          ...
          <v-card>
            ...
            <v-card-text>
              <v-form>
                ...
                <v-text-field disabled name="Shipping Address" label="Shipping Address" type="text"></v-text-field>
                <v-text-field disabled name="Billing Address" label="Billing Address" type="text"></v-text-field>
                <v-text-field disabled name="Card Number" label="Card Number" type="text"></v-text-field>
                <v-text-field disabled name="CVV" label="CVV" type="text"></v-text-field>
                <v-text-field disabled name="Zip Code" label="Zip Code" type="text"></v-text-field>
              </v-form>
            </v-card-text>
            <v-card-actions>
              <v-spacer></v-spacer>
              <v-btn disabled>Place Order</v-btn>
            </v-card-actions>
              <v-alert :value="true" type="warning">
                This site is a mock-up. For your safety the submission of sensitive personal information has been disabled.
              </v-alert>
          </v-card>
        </v-flex>
      </v-layout>
